    ...
    init {
        describe("GlobalGlossary") {
            it("完整 CUID 與版本/Diff/Used 更新驗證") {
                ...
                val created = repo.create(name, content, tag, by = userIdStr)
                val id = created.id
                ...
                initialRecord.by shouldBe userIdStr
